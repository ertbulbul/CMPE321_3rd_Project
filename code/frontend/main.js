...
init = () => {
    window.onload = function () {
        if(window.location == 'file:///C:/Users/asus/Desktop/code/frontend/borrow.html'){
            setBorrowerPage();
        }else if(window.location == 'file:///C:/Users/asus/Desktop/code/frontend/index.html'){
            getBorrowedBooks();
            setMainPageEvents();
        }else if(window.location == 'file:///C:/Users/asus/Desktop/code/frontend/library.html'){
            setLibraryPage();
        }
...
setMainPageEvents = () => {
    ...
    jQuery('.borrowerBtn').on('click', function () {        
        window.location = 'file:///C:/Users/asus/Desktop/code/frontend/borrow.html';
        
    });

    jQuery('.libraryBtn').on('click', function () {
        window.location = 'file:///C:/Users/asus/Desktop/code/frontend/library.html';
